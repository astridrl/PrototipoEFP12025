...
//Se copia todo el contenido de proveedor.dat a BackupProveedores.dat
bool proveedor::backupProveedores() {
    ...
    backupFile.open("BackupProveedores.dat", ios::out | ios::binary);
    if (!backupFile) {
    ...
    file.close();
    backupFile.close();
    cout << "\n\t\tBackup realizado con éxito en 'BackupProveedores.dat'" << endl;
